...
const char* getVertexShaderSource()
{
    ...
    return
                ...
                "   vertexColor = aColor;"
                // ********************** FLIP TRINAGLE HERE **********************
                "   gl_Position = vec4(aPos.x, -aPos.y, aPos.z, 1.0);" // -aPos.y will flip the triangle, we dont modifiy the vertex array
                "}";
}
...
const char* getFragmentShaderSource()
{
    ...
    "void main()"
    "{"
    // "   FragColor = vec4(vertexColor.r, vertexColor.g, vertexColor.b, 1.0f);" Regular Color for the triangle (default one)
    "   FragColor = vec4(1.0, 1.0, 1.0, 1.0);" // By setting everything to one, you have all colors -> white
    "}";
}
...
int main(int argc, char*argv[])
{
    ...
    // ******************* Burgundy Background *******************
    glClearColor(0.388f, 0.082f, 0.137f, 1.0f);
